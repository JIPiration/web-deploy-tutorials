...
import keras
#out handwritten character labeled dataset
from keras.datasets import mnist
#because out models are simple
...
#For 30 data, "channels_last" assumes (conv_dim1, conv_dim2, conv_dim3, channels) while
...
#randomly turn neurons on and off to imporve convergence
model.add(Dropout(0.25))
#flatten since too many dimensions, we only want a classification output
model.add(Flatten())
#fully connected to get adll relevant data
model.add(Dense(128, activation='relu'))
#one more dropout for convergence' sake
model.add(Dropout(0.5))
#output a sofrmax to squash the matrix into output probabilities
